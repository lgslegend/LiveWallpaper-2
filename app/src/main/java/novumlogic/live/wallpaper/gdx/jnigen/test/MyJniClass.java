...
package novumlogic.live.wallpaper.gdx.jnigen.test;

import java.nio.Buffer;
import java.nio.ByteBuffer;

import novumlogic.live.wallpaper.gdx.jnigen.AntScriptGenerator;
import novumlogic.live.wallpaper.gdx.jnigen.BuildConfig;
import novumlogic.live.wallpaper.gdx.jnigen.BuildExecutor;
import novumlogic.live.wallpaper.gdx.jnigen.BuildTarget;
import novumlogic.live.wallpaper.gdx.jnigen.BuildTarget.TargetOs;
import novumlogic.live.wallpaper.gdx.jnigen.JniGenSharedLibraryLoader;
import novumlogic.live.wallpaper.gdx.jnigen.NativeCodeGenerator;
