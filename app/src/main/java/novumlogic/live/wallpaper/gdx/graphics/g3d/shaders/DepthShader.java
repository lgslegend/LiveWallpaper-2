...
public class DepthShader extends DefaultShader {
	...
	public final static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/shaders/depth.vertex.glsl").readString();
	...
	public final static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/shaders/depth.fragment.glsl").readString();
