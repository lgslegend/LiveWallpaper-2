...
public class FrameBufferCubemap extends GLFrameBuffer<Cubemap> {
	 ...
	 * @throws novumlogic.live.wallpaper.gdx.utils.GdxRuntimeException in case the FrameBuffer could not be created */
	 ...
	 * {@link #bindSide(novumlogic.live.wallpaper.gdx.graphics.Cubemap.CubemapSide)} to activate the side to render onto. */
	@Override
	public void bind () {
		currentSide = -1;
		super.bind();
