...
import static novumlogic.live.wallpaper.gdx.utils.Align.*;
...
import novumlogic.live.wallpaper.gdx.graphics.glutils.ShapeRenderer.ShapeType;
...
import novumlogic.live.wallpaper.gdx.scenes.scene2d.utils.ActorGestureListener;
...
import novumlogic.live.wallpaper.gdx.utils.DelayedRemovalArray;
...
public class Actor {
	 ...
	 * {@link Batch#draw(novumlogic.live.wallpaper.gdx.graphics.g2d.TextureRegion, float, float, float, float, float, float, float, float, float)
