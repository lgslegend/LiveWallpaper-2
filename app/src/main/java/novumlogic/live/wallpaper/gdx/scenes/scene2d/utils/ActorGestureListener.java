...
package novumlogic.live.wallpaper.gdx.scenes.scene2d.utils;

import novumlogic.live.wallpaper.gdx.input.GestureDetector;
import novumlogic.live.wallpaper.gdx.input.GestureDetector.GestureAdapter;
...
import novumlogic.live.wallpaper.gdx.scenes.scene2d.EventListener;
...
public class ActorGestureListener implements EventListener {
	...
	/** @see GestureDetector#GestureDetector(novumlogic.live.wallpaper.gdx.input.GestureDetector.GestureListener) */
	public ActorGestureListener () {
		this(20, 0.4f, 1.1f, 0.15f);
	}

	/** @see GestureDetector#GestureDetector(float, float, float, float, novumlogic.live.wallpaper.gdx.input.GestureDetector.GestureListener) */
