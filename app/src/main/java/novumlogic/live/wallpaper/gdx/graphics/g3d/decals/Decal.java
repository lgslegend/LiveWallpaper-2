...
package novumlogic.live.wallpaper.gdx.graphics.g3d.decals;
...
public class Decal {
	 ...
	 * @return Created decal */
	// TODO : it would be convenient if {@link novumlogic.live.wallpaper.gdx.graphics.Texture} had a getFormat() method to assume transparency
// from RGBA,..
