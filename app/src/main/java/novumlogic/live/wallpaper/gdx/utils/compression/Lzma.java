...
package novumlogic.live.wallpaper.gdx.utils.compression;
...
public class Lzma {
	...
	static public void compress (InputStream in, OutputStream out) throws IOException {
		...
		novumlogic.live.wallpaper.gdx.utils.compression.lzma.Encoder encoder = new novumlogic.live.wallpaper.gdx.utils.compression.lzma.Encoder();
	...
	static public void decompress (InputStream in, OutputStream out) throws IOException {
		...
		novumlogic.live.wallpaper.gdx.utils.compression.lzma.Decoder decoder = new novumlogic.live.wallpaper.gdx.utils.compression.lzma.Decoder();
