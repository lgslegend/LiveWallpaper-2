 ...
 * {@link ModelBatch#begin(novumlogic.live.wallpaper.gdx.graphics.Camera)} and {@link ModelBatch#end()}. Therefor Renderable instances cannot
...
public class Renderable {
	 ...
	 * {@link novumlogic.live.wallpaper.gdx.graphics.VertexAttributes.Usage#BoneWeight} vertex attributes, then the BoneWeight index is used as
