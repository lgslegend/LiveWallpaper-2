...
package novumlogic.live.wallpaper.gdx.assets;

import java.util.Stack;

import novumlogic.live.wallpaper.gdx.Application;
import novumlogic.live.wallpaper.gdx.assets.loaders.AssetLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.BitmapFontLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.CubemapLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.FileHandleResolver;
import novumlogic.live.wallpaper.gdx.assets.loaders.I18NBundleLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.MusicLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.ParticleEffectLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.PixmapLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.ShaderProgramLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.SkinLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.SoundLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.TextureAtlasLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.TextureLoader;
import novumlogic.live.wallpaper.gdx.assets.loaders.resolvers.InternalFileHandleResolver;
import novumlogic.live.wallpaper.gdx.audio.Music;
import novumlogic.live.wallpaper.gdx.audio.Sound;
import novumlogic.live.wallpaper.gdx.graphics.Cubemap;
import novumlogic.live.wallpaper.gdx.graphics.Pixmap;
import novumlogic.live.wallpaper.gdx.graphics.Texture;
import novumlogic.live.wallpaper.gdx.graphics.g2d.BitmapFont;
import novumlogic.live.wallpaper.gdx.graphics.g2d.ParticleEffect;
import novumlogic.live.wallpaper.gdx.graphics.g2d.PolygonRegion;
import novumlogic.live.wallpaper.gdx.graphics.g2d.PolygonRegionLoader;
import novumlogic.live.wallpaper.gdx.graphics.g2d.TextureAtlas;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Model;
import novumlogic.live.wallpaper.gdx.graphics.g3d.loader.G3dModelLoader;
import novumlogic.live.wallpaper.gdx.graphics.g3d.loader.ObjLoader;
import novumlogic.live.wallpaper.gdx.graphics.glutils.ShaderProgram;
import novumlogic.live.wallpaper.gdx.scenes.scene2d.ui.Skin;
import novumlogic.live.wallpaper.gdx.utils.Array;
import novumlogic.live.wallpaper.gdx.utils.Disposable;
import novumlogic.live.wallpaper.gdx.utils.GdxRuntimeException;
import novumlogic.live.wallpaper.gdx.utils.I18NBundle;
import novumlogic.live.wallpaper.gdx.utils.JsonReader;
import novumlogic.live.wallpaper.gdx.utils.Logger;
import novumlogic.live.wallpaper.gdx.utils.ObjectIntMap;
import novumlogic.live.wallpaper.gdx.utils.ObjectMap;
import novumlogic.live.wallpaper.gdx.utils.ObjectSet;
import novumlogic.live.wallpaper.gdx.utils.TimeUtils;
import novumlogic.live.wallpaper.gdx.utils.UBJsonReader;
import novumlogic.live.wallpaper.gdx.utils.async.AsyncExecutor;
import novumlogic.live.wallpaper.gdx.utils.async.ThreadUtils;
import novumlogic.live.wallpaper.gdx.utils.reflect.ClassReflection;
...
public class AssetManager implements Disposable {
	...
	public AssetManager (FileHandleResolver resolver, boolean defaultLoaders) {
		...
		if (defaultLoaders) {
			...
			setLoader(novumlogic.live.wallpaper.gdx.graphics.g3d.particles.ParticleEffect.class,
				new novumlogic.live.wallpaper.gdx.graphics.g3d.particles.ParticleEffectLoader(resolver));
