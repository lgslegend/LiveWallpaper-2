...
package novumlogic.live.wallpaper.gdx.graphics.g3d.shaders;
...
import novumlogic.live.wallpaper.gdx.graphics.VertexAttributes.Usage;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Attribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Attributes;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Environment;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Renderable;
import novumlogic.live.wallpaper.gdx.graphics.g3d.Shader;
...
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.CubemapAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.DepthTestAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.DirectionalLightsAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.FloatAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.IntAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.PointLightsAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.SpotLightsAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.attributes.TextureAttribute;
import novumlogic.live.wallpaper.gdx.graphics.g3d.environment.AmbientCubemap;
import novumlogic.live.wallpaper.gdx.graphics.g3d.environment.DirectionalLight;
import novumlogic.live.wallpaper.gdx.graphics.g3d.environment.PointLight;
import novumlogic.live.wallpaper.gdx.graphics.g3d.environment.SpotLight;
import novumlogic.live.wallpaper.gdx.graphics.g3d.utils.RenderContext;
import novumlogic.live.wallpaper.gdx.graphics.glutils.ShaderProgram;
import novumlogic.live.wallpaper.gdx.math.Matrix3;
...
public class DefaultShader extends BaseShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/shaders/default.vertex.glsl").readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/shaders/default.fragment.glsl").readString();
