...
public class AndroidNdkScriptGenerator {
	public void generate (BuildConfig config, BuildTarget target) {
		...
		application.writeString(new FileDescriptor("novumlogic.live.wallpaper.gdx.jnigen/resources/scripts/Application.mk.template",
			FileType.Classpath).readString(), false);

		// create Android.mk file
		String template = new FileDescriptor("novumlogic.live.wallpaper.gdx.jnigen/resources/scripts/Android.mk.template", FileType.Classpath)
			.readString();
