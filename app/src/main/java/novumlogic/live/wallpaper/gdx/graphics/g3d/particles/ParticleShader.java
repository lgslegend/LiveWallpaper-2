...
package novumlogic.live.wallpaper.gdx.graphics.g3d.particles;
...
import novumlogic.live.wallpaper.gdx.graphics.g3d.Material;
...
import novumlogic.live.wallpaper.gdx.graphics.g3d.shaders.BaseShader;
import novumlogic.live.wallpaper.gdx.graphics.g3d.shaders.DefaultShader;
...
public class ParticleShader extends BaseShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/particles/particles.vertex.glsl").readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("novumlogic.live.wallpaper.gdx/graphics/g3d/particles/particles.fragment.glsl")
				.readString();
