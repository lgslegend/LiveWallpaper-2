...
import novumlogic.live.wallpaper.gdx.ApplicationLogger;
import novumlogic.live.wallpaper.gdx.Audio;
import novumlogic.live.wallpaper.gdx.Files;
...
import novumlogic.live.wallpaper.gdx.Net;
import novumlogic.live.wallpaper.gdx.Preferences;
...
import novumlogic.live.wallpaper.gdx.utils.Clipboard;
import novumlogic.live.wallpaper.gdx.utils.GdxNativesLoader;
...
public class AndroidApplication extends Activity implements AndroidApplicationBase {
	...
	private void init (ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
		...
		if (this.useImmersiveMode && getVersion() >= Build.VERSION_CODES.KITKAT) {
			try {
				Class<?> vlistener = Class.forName("novumlogic.live.wallpaper.backends.AndroidVisibilityListener");
