...
import novumlogic.live.wallpaper.backends.surfaceview.FillResolutionStrategy;
...
public class AndroidApplicationConfiguration {
	 ...
	 *  When GL ES 3* is enabled, {@link novumlogic.live.wallpaper.gdx.Gdx#gl30} can be used to access its functionality. Requires at least Android 4.3 (API level 18).
	...
	/** whether to use {@link novumlogic.live.wallpaper.backends.surfaceview.GLSurfaceView20API18} in place of the classic
	 * {@link novumlogic.live.wallpaper.backends.surfaceview.GLSurfaceView20} on Android API 10 and lower.
	 * In case this is true {@link novumlogic.live.wallpaper.backends.surfaceview.GLSurfaceView20API18} will be used.
